...
void
NotificationManager::connectSlot(QString signal, const char* slot)
{
...
void
NotificationManager::sendMessage(const QString &roomid,
 ...
 */
uint
NotificationManager::showNotification(const QString summary, const QString text, const QImage image)
{
        QVariantMap hints;
...
void
NotificationManager::actionInvoked(uint id, QString action)
{
...
void
NotificationManager::notificationClosed(uint id, uint reason)
{
        Q_UNUSED(reason);
